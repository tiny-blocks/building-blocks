 ...
 *
 * <p>Typical implementations check the aggregate's sequence number against a threshold (for example, take
 * a snapshot every <em>N</em> events) or combine sequence checks with a time-based policy. Keeping the
